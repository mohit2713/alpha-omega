...
// import car from "../assets/file copy.avif";
import ImageCarousel from "./ImageCarousel";

const Dashboard = () => {
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-md mt-10 flex flex-col md:flex-row gap-8">
      ...
      <div className="flex-1 space-y-4">
        ...
        <div className="flex items-center space-x-2 bg-purple-100 px-3 py-2 rounded-lg">
          <div className="bg-purple-600 text-white px-2 py-1 rounded text-xs font-semibold">S Assured</div>
          <span className="text-sm text-gray-700">High quality, less driven</span>
        ...
        <div className="mt-6 space-y-2">
          ...
          <p className="text-sm text-gray-600">Includes RC transfer, insurance & more</p>
        </div>
